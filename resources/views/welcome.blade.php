...
<body class="bg-light">
        <div class="d-flex justify-content-center align-items-center vh-100">
            <div class="card shadow d-flex justify-content-center align-items-center w-50 h-25">
                <h2 class="card-title py-5">Welcome to Alex Hospital</h5>
                <div class="card-body ">
                        @if (Route::has('login'))
                        <div>
                            @auth
                                <a href="{{ url('/dashboard') }}" class="link-secondary">Dashboard</a>
                            @else
                                <a href="{{ route('login') }}" class="link-secondary px-2">Log in</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="link-secondary px-2">Register</a>
                                @endif
                            @endauth
                        </div>
                    @endif
